...
using CreateProviderUnion = OneOf<UserSelected, Preselected>;
using RetryUnion = OneOf<Standard, Smart>;

/// <summary>
/// Payment Method types for CREATE payment requests
/// </summary>
public static class CreatePaymentMethod
{
    ...
    public record BankTransfer : IDiscriminated
    {
        ...
        public BankTransfer(CreateProviderUnion providerSelection, BeneficiaryUnion beneficiary, BaseRetry? retry = null)
        {
        ...
        /// </summary>
        public CreateProviderUnion ProviderSelection { get; init; }
