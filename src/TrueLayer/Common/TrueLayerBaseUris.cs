...
{
    internal static readonly Uri ProdApiBaseUri = new("https://api.truelayer.com/v3");
    internal static readonly Uri SandboxApiBaseUri = new("https://api.truelayer-sandbox.com/v3");
