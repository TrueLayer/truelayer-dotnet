...
namespace TrueLayer
{
    ...
    internal interface IApiClient
    {
        ...
        /// <typeparam name="TData">The expected response type to be deserialized.</typeparam>
        /// <returns>A task that upon completion contains the specified API response data.</returns>
        Task<ApiResponse<TData>> PostAsync<TData>(Uri uri, object? request = null, string? accessToken = null, SigningKey? signingKey = null, CancellationToken cancellationToken = default);
    }
}
