...
## [0.3.3] - 2023-01-10
### Removed
- Some user information from payment response [TrueLayer Changelog](https://docs.truelayer.com/changelog/removal-of-user-info-in-payment-and-mandate-response).
    * `name`
    * `email`
    * `phone`
    * `date_of_birth`
